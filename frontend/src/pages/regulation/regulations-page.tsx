...
import {
  useDeleteRegulationByIdMutation,
  useRegulations,
...
const RegulationsPage = () => {
  ...
  const { mutateAsync: deleteRegulationById } =
    useDeleteRegulationByIdMutation();
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          {isLoading && (
            <div className="text-center p-8">
              ...
              <p className="mt-2 text-gray-500">Loading regulations...</p>
            </div>
          )}
            ...
            <>
              ...
              {regulations.length === 0 && (
                <div className="text-center p-8 text-gray-500">
                  No regulations found. Upload your first regulation to get
                  started.
                </div>
              )}
