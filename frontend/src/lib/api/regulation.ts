...
export type FileUploadResponse =
  operations["upload_regulation_file_regulations_file_post"]["responses"][200]["content"]["application/json"];
...
export const regulationApi = {
  ...
  deleteRegulationById: async (regulationId: number): Promise<void> => {
    return apiClient.delete(`/regulations/${regulationId}`);
  },
};
