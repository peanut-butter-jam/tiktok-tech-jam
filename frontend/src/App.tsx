...
import RegulationsPage from "./pages/regulation/regulations-page";
import RegulationView from "./pages/regulation/regulation-view-page";
import { ThemeProvider } from "./contexts/theme/theme-provider";
import { Toaster } from "./shared/ui/sonner";
import RegulationUpload from "./pages/regulation/regulation-upload";
